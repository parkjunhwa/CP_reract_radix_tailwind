...
const labelConfig = {
  work: { label: "Work", cls: "bg-sky-500/10 text-sky-500 border-sky-500/20" },
  personal: { label: "Personal", cls: "bg-emerald-500/10 text-emerald-500 border-emerald-500/20" },
  vip: { label: "VIP", cls: "bg-amber-500/10 text-amber-500 border-amber-500/20" },
};
