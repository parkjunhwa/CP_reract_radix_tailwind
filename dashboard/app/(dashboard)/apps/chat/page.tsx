        ...
        <div className="w-72 flex-shrink-0 flex flex-col" style={{ borderRight: "1px solid var(--t-border)" }}>
          <div className="p-4 space-y-3" style={{ borderBottom: "1px solid var(--t-border)" }}>
            <div className="flex items-center justify-between">
              ...
              <button className="p-1.5 rounded-md t-text-30 hover:t-text-70 hover:bg-[var(--t-hover)] transition-colors"><Plus className="w-4 h-4" /></button>
            </div>
          ...
          {activeContact && (
            <>
              ...
              <div className="flex items-center gap-3 px-5 py-3" style={{ borderBottom: "1px solid var(--t-border)" }}>
                ...
                <button className="p-2 rounded-lg t-text-30 hover:t-text-70 hover:bg-[var(--t-hover)] transition-colors"><Phone className="w-4 h-4" /></button>
                <button className="p-2 rounded-lg t-text-30 hover:t-text-70 hover:bg-[var(--t-hover)] transition-colors"><Video className="w-4 h-4" /></button>
                <button className="p-2 rounded-lg t-text-30 hover:t-text-70 hover:bg-[var(--t-hover)] transition-colors"><MoreHorizontal className="w-4 h-4" /></button>
              </div>
              ...
              <div className="p-4" style={{ borderTop: "1px solid var(--t-border)" }}>
                <div className="flex items-center gap-2 rounded-xl border px-3 py-2.5" style={{ backgroundColor: "var(--t-input-bg)", borderColor: "var(--t-border-2)" }}>
                  <button className="t-text-30 hover:t-text-70 transition-colors"><Paperclip className="w-4 h-4" /></button>
                  <input value={input} onChange={e => setInput(e.target.value)}
                    onKeyDown={e => { if (e.key === "Enter" && input.trim()) setInput(""); }}
                    placeholder="Type a message…" className="flex-1 bg-transparent text-xs outline-none text-[color:var(--t-text-70)] placeholder:text-[color:var(--t-text-30)]" />
                  <button className="t-text-30 hover:t-text-70 transition-colors"><Smile className="w-4 h-4" /></button>
                  <button
