...
export default function ForgotPasswordPage() {
  ...
  return (
    <div
      data-theme="dark"
      className="min-h-screen flex items-center justify-center px-4 scheme-dark text-white"
          ...
          {sent ? (
            <div className="space-y-3">
              ...
              <p className="text-slate-400 text-sm">
                We&apos;ve sent a password reset link to <span className="text-white">{email}</span>. Check your inbox.
              </p>
              <Link
                href="/login"
                className="inline-flex items-center gap-2 text-sm text-violet-400 hover:text-violet-300 transition-colors mt-4"
              >
            ...
            <>
              ...
              <Form.Root onSubmit={handleSubmit} className="space-y-3 text-left">
                <Form.Field name="email" className="space-y-1.5">
                  <Form.Label asChild>
                    <Label htmlFor="forgot-email" className="text-sm text-slate-400">Email</Label>
                  </Form.Label>
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-300 transition-colors mt-5"
              >
